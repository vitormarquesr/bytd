...
#include "stanExports_marginal_prob.h"

RCPP_MODULE(stan_fit4marginal_prob_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_marginal_prob")
