...
#include "stanExports_marginal_lambda.h"

RCPP_MODULE(stan_fit4marginal_lambda_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_marginal_lambda")
