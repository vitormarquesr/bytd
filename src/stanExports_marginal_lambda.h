...
namespace model_marginal_lambda_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 38> locations_array__ =
  {" (found before start of program)",
  " (in 'marginal_lambda', line 22, column 2 to column 18)",
  " (in 'marginal_lambda', line 23, column 2 to column 22)",
  " (in 'marginal_lambda', line 24, column 2 to column 18)",
  " (in 'marginal_lambda', line 25, column 2 to column 18)",
  " (in 'marginal_lambda', line 26, column 2 to column 28)",
  " (in 'marginal_lambda', line 39, column 2 to column 20)",
  " (in 'marginal_lambda', line 41, column 4 to column 73)",
  " (in 'marginal_lambda', line 40, column 2 to line 41, column 73)",
  " (in 'marginal_lambda', line 29, column 2 to column 46)",
  " (in 'marginal_lambda', line 30, column 2 to column 34)",
  " (in 'marginal_lambda', line 31, column 2 to column 34)",
  " (in 'marginal_lambda', line 32, column 2 to column 34)",
  " (in 'marginal_lambda', line 33, column 2 to column 27)",
  " (in 'marginal_lambda', line 35, column 4 to column 70)",
  " (in 'marginal_lambda', line 34, column 16 to line 36, column 3)",
  " (in 'marginal_lambda', line 34, column 2 to line 36, column 3)",
  " (in 'marginal_lambda', line 11, column 2 to column 19)",
  " (in 'marginal_lambda', line 12, column 2 to column 34)",
  " (in 'marginal_lambda', line 13, column 2 to column 30)",
  " (in 'marginal_lambda', line 14, column 2 to column 30)",
  " (in 'marginal_lambda', line 15, column 2 to column 30)",
  " (in 'marginal_lambda', line 16, column 20 to column 21)",
  " (in 'marginal_lambda', line 16, column 2 to column 25)",
  " (in 'marginal_lambda', line 17, column 20 to column 21)",
  " (in 'marginal_lambda', line 17, column 2 to column 25)",
  " (in 'marginal_lambda', line 18, column 20 to column 21)",
  " (in 'marginal_lambda', line 18, column 2 to column 25)",
  " (in 'marginal_lambda', line 19, column 20 to column 21)",
  " (in 'marginal_lambda', line 19, column 2 to column 29)",
  " (in 'marginal_lambda', line 26, column 18 to column 19)",
  " (in 'marginal_lambda', line 39, column 9 to column 10)",
  " (in 'marginal_lambda', line 3, column 4 to column 12)",
  " (in 'marginal_lambda', line 4, column 4 to column 12)",
  " (in 'marginal_lambda', line 5, column 4 to column 44)",
  " (in 'marginal_lambda', line 6, column 4 to column 90)",
  " (in 'marginal_lambda', line 7, column 4 to column 19)",
  " (in 'marginal_lambda', line 2, column 82 to line 8, column 3)"};
...
class model_marginal_lambda final : public model_base_crtp<model_marginal_lambda> {
private:
  int n;
...
public:
  ~model_marginal_lambda() {}
  model_marginal_lambda(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_marginal_lambda_namespace::model_marginal_lambda";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_marginal_lambda_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_marginal_lambda_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_marginal_lambda_namespace::model_marginal_lambda;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_marginal_lambda_namespace::profiles__;
}
#endif
#endif
